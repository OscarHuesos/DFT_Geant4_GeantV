...
: G4UImessenger(),
  ...
  fpDrawNucleotides = new G4UIcmdWithoutParameter(
      "/PDB4DNA/det/drawNucleotides",this);
  ...
  fpBuildBoundingV = new G4UIcmdWithoutParameter(
      "/PDB4DNA/det/buildBoundingV",  this);
  ...
  fpDrawAtomsWithBounding = new G4UIcmdWithoutParameter(
      "/PDB4DNA/det/drawAtomsWithBounding",this);
  ...
  fpDrawNucleotidesWithBounding = new G4UIcmdWithoutParameter(
      "/PDB4DNA/det/drawNucleotidesWithBounding",this);
  ...
  fpDrawResiduesWithBounding = new G4UIcmdWithoutParameter(
      "/PDB4DNA/det/drawResiduesWithBounding",this);
  ...
  fpEnergy_analysis = new G4UIcmdWithoutParameter(
    "/PDB4DNA/det/Energy_analysis",this);
